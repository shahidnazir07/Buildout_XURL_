public class XUrlMain {
  ...
  public static void main(String[] args) {
    ...
    // Test the Short Url Implementation by registering long URLs and looking up
    // short URLs
    ...
    assert (xUrl.getHitCount("htt/p:/abcn.com").equals(0));

    // From the short URL url1, remove the common section (http://short.url/) and
    ...
    // Delete mapping for the long URL and confirm that the short URL lookup for
    // that long URL returns null
